...
mystartfile += '</xml>';
  ...
  Code.bindClick('trashButton',
      function() {
          ...
          if (confirm("Are you sure you want to discard all the blocks ?")) {
            Code.discard(); Code.renderContent();
          } else {
            alert("Blocks not discarted.");
            return;
          }
...
Code.initLanguage = function() {
  ...
  var tab_blocks = document.getElementById('tab_blocks');
  var linkButton = document.getElementById('linkButton');
  ...
  tab_blocks.textContent = MSG['blocks'];
