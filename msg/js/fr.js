...
Blockly.Msg.INOUT_HIGH_LEVEL="HAUT";
Blockly.Msg.INOUT_LOW_LEVEL="BAS";
Blockly.Msg.INPOUT_DIGITAL_WRITE="Ecriture numérique PIN#";
Blockly.Msg.INOUT_STAT="Niveau";
Blockly.Msg.INOUT_DIG_READ="Lecture numérique PIN#";
Blockly.Msg.INOUT_BUI_LED="LED intégrée Niveau";
Blockly.Msg.INOUT_ANA_READ="Lecture analogique PIN#";
Blockly.Msg.INOUT_ANA_WRITE="Ecriture analogique";
Blockly.Msg.INOUT_VALUE="Valeur";


//SERIAL
Blockly.Msg.Serial_Print="Afficher nouvelle ligne";
Blockly.Msg.Serial_PrintL="Afficher même ligne";
...
Blockly.Msg.PIN="PIN#";
Blockly.Msg.Degree="Degré (0~180)";
Blockly.Msg.Delay="Délai";
Blockly.Msg.SERVO_ReadDegree="Lecture degré";
Blockly.Msg.SERVO_Attached="Servo Attaché?";
Blockly.Msg.SERVO_Detach="Détacher Servo PIN#";

//SERIAL LCD
Blockly.Msg.LCD_Serial="Serial LCD";
Blockly.Msg.LCD_Print_Line1="Afficher ligne 1";
Blockly.Msg.LCD_Print_Line2="Afficher ligne 2";
Blockly.Msg.Power="Power";
Blockly.Msg.ONN="ON";
Blockly.Msg.OFFF="OFF";
Blockly.Msg.LCD_Effect="Effet";
Blockly.Msg.LCD_Scroll_Left="Défiler à gauche";
Blockly.Msg.LCD_Scroll_Right="Défiler à droite";
Blockly.Msg.LCD_Scroll_Auto="Défiler automatiquement";

//LCD PARALLEL
Blockly.Msg.LCDP_Setup = "LCD Setup";
Blockly.Msg.LCDP_RS = "Réinitialiser";
Blockly.Msg.LCDP_Enabled = "Activé";
Blockly.Msg.LCDP_D4 = "D4";
Blockly.Msg.LCDP_D5 = "D5";
Blockly.Msg.LCDP_D6 = "D6";
Blockly.Msg.LCDP_D7 = "D7";
Blockly.Msg.LCDP_Column = "Colonne";
Blockly.Msg.LCDP_Row = "Ligne";
Blockly.Msg.LCDP_Print = "LCD Afficher";
Blockly.Msg.LCDP_Clear = "LCD Effacer";
Blockly.Msg.LCDP_scrollDisplayLeft = "LCD Défiler l'affichage à gauche ";
Blockly.Msg.LCDP_scrollDisplayRight = "LCD Défiler l'affichage à droite ";
Blockly.Msg.LCDP_Home = "LCD Début";
Blockly.Msg.LCDP_SetCursor = "LCD positionner curseur";
Blockly.Msg.LCDP_Display = "LCD Affichage";
Blockly.Msg.LCDP_noDiplay = "LCD Pas d'affichage";
Blockly.Msg.LCD_I2C_setup = "SETUP LCD série I2C Adresse";


//VARIOUS
Blockly.Msg.VAR_TemSens="Capteur de température";
Blockly.Msg.VAR_Motor="Moteur";
Blockly.Msg.Stop="Stop";
Blockly.Msg.Forward="Avance";
Blockly.Msg.Right="Droite";
Blockly.Msg.Left="Gauche";
Blockly.Msg.Backward="Arrière";
Blockly.Msg.DelayMs="Délai Ms";
Blockly.Msg.SinceProgramStarted="Le programme a commencé depuis";
Blockly.Msg.RandomBetween="Nombre aléatoire entre";
Blockly.Msg.And="et";
Blockly.Msg.Constrain="Contraindre";
Blockly.Msg.Number="Nombre";
Blockly.Msg.NumberA="A";
Blockly.Msg.NumberB="B";
Blockly.Msg.PulseIn="Pulse In";
Blockly.Msg.ultrasonic_ranger="Capteur Ultrason";
Blockly.Msg.unit="Unité";
Blockly.Msg.cm="cm";
Blockly.Msg.inch="pouce";
Blockly.Msg.TRIG="TRIG Déclencher";
Blockly.Msg.Echo="Echo"; 

//LOOPS
Blockly.Msg.Break = "Interruption";
Blockly.Msg.continue = "Continue";
Blockly.Msg.returnnull = "FRReturn";

//VARIABLES 
Blockly.Msg.Var_Declare="Déclare";
Blockly.Msg.Var_As="en tant que";

//Math "Map "
Blockly.Msg.Math_map="Transformer "; 
Blockly.Msg.Math_valueto="valeur à [0-";

//STRING SET
Blockly.Msg.STRING_SET = "Fixer chaine %1 à %2";
Blockly.Msg.STRING_SET_CREATE_GET = "Créer chaine 'recevoir %1'";
Blockly.Msg.STRING_SET_HELPURL = "https://github.com/google/blockly/wiki/Variables#set";
Blockly.Msg.STRING_SET_TOOLTIP = "FRSets this string to be equal to the input.";
Blockly.Msg.RENAME_VARIABLE = "Renanommer variable...";
Blockly.Msg.String_As="comme chaine";
Blockly.Msg.STRING_charat="Caractère dans %1 à %2";
Blockly.Msg.STRING_charat2="Caractère à";
Blockly.Msg.STRING_compareTo="Comparer à";
Blockly.Msg.STRING_Contact="Concatener ";
Blockly.Msg.STRING_LengthOf="Taille de ";
Blockly.Msg.STRING_Ends_With="Se termine par ";
Blockly.Msg.STRING_Equal="Egual à ";


//Conversions
Blockly.Msg.CONV_tochar="Convertir à char "; 
Blockly.Msg.CONV_tobyte="Convertir à Byte ";
Blockly.Msg.CONV_toint="Convertir à Int ";
Blockly.Msg.CONV_tofloat="Convertir à Float ";

// Advanced IO
Blockly.Msg.TonePin="Note PIN#";
Blockly.Msg.Frequence="Fréquence";
Blockly.Msg.Duration="Durée";
Blockly.Msg.NoTonePin="Pas de note PIN#";
Blockly.Msg.Setup="Setup";
Blockly.Msg.Loop="Boucle principale";
...
//ADDED 26 11 2016
Blockly.Msg.Math_map2="Transformer";
Blockly.Msg.Math_value="valeur"; 
Blockly.Msg.Math_fromLow="de V. inférieur";
Blockly.Msg.Math_fromHigh="de V. supérieur";
Blockly.Msg.Math_toLow="à V. inférieur";
Blockly.Msg.Math_toHigh="à V. supérieur";