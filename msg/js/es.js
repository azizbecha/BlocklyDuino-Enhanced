...
//SERIAL
 ...
 Blockly.Msg.Serial_Print_Format="Imprime Formato";
...
Blockly.Msg.Serial_Print_ForOct="octal";
 Blockly.Msg.Serial_read="Lee Serial";
...
Blockly.Msg.LCD_Print_Line1="imprime línea 1";
 Blockly.Msg.LCD_Print_Line2="imprime línea 2";
 Blockly.Msg.Power="Energía";
 Blockly.Msg.ONN="Encendida";
 Blockly.Msg.OFFF="Apagada";
Blockly.Msg.LCD_Effect="Efecto";
 Blockly.Msg.LCD_Scroll_Left="Desplazar Izquierda";
 Blockly.Msg.LCD_Scroll_Right="Desplazar Derecha";
Blockly.Msg.LCD_Scroll_Auto="Desplazar Automático";




//LCD PARALLEL
 Blockly.Msg.LCDP_Setup = "Configuración LCD";
 Blockly.Msg.LCDP_RS = "RS";
 Blockly.Msg.LCDP_Enabled = "Activado";
...
Blockly.Msg.LCDP_Print = "IMPRIME LCD";
 Blockly.Msg.LCDP_Clear = "Borra LCD ";
 Blockly.Msg.LCDP_scrollDisplayLeft = "Desplazar Izquierda LCDP "; 
 Blockly.Msg.LCDP_scrollDisplayRight = "Desplazar Derecha LCDP ";
 Blockly.Msg.LCDP_Home = "Inicio LCD ";
Blockly.Msg.LCDP_SetCursor = "LCD establecer Cursor";
 Blockly.Msg.LCDP_Display = " mostrar LCD ";
 Blockly.Msg.LCDP_noDiplay = "LCD no mostrar";
Blockly.Msg.LCD_I2C_setup = "CONFIGURAR SERIAL LCD I2C Dirección";


//VARIOUS
Blockly.Msg.VAR_TemSens="Sensor de temperatura";
Blockly.Msg.VAR_Motor="Motor";
Blockly.Msg.Stop="Detener";
 Blockly.Msg.Forward="Hacia delante";
 Blockly.Msg.Right="Derecha";
 Blockly.Msg.Left="Izquierda";
 Blockly.Msg.Backward="Hacia atrás";
 Blockly.Msg.DelayMs="Espera Ms";
 Blockly.Msg.SinceProgramStarted="Programa empezado hace";
 Blockly.Msg.RandomBetween="Número aleatorio entre";
 Blockly.Msg.And="y";
 Blockly.Msg.Constrain="Restringir";
 Blockly.Msg.Number="Número";
Blockly.Msg.NumberA="A";
Blockly.Msg.NumberB="B";
 Blockly.Msg.PulseIn="Pulso de entrada";
 Blockly.Msg.ultrasonic_ranger=" Rango Ultrasónico";
 Blockly.Msg.unit="Unidad";
 Blockly.Msg.cm="cm";
 Blockly.Msg.inch="pulgada";
 Blockly.Msg.TRIG="TRIG Disparador";
...
//LOOPS
Blockly.Msg.Break = "Break"; Blockly.Msg.Break = "Sal de bucle";
Blockly.Msg.continue = "Continue"; Blockly.Msg.continue = "Continua";
Blockly.Msg.returnnull = "Return"; Blockly.Msg.returnnull = "Devuelve";




//VARIABLES
Blockly.Msg.Var_Declare="Declare"; Blockly.Msg.Var_Declare="Declara";
Blockly.Msg.Var_As="as"; Blockly.Msg.Var_As="como";




//Math "Map "
Blockly.Msg.Math_map="Map "; Blockly.Msg.Math_map="Mapea ";
Blockly.Msg.Math_valueto="value to [0-"; Blockly.Msg.Math_valueto="valor de [0-";




//STRING SET
Blockly.Msg.STRING_SET = "configura Cadena de Caracteres %1 a %2";
Blockly.Msg.STRING_SET_CREATE_GET = "Create String 'get %1'"; Blockly.Msg.STRING_SET_CREATE_GET = "Crea Cadena de caracteres 'obten %1'";
Blockly.Msg.STRING_SET_HELPURL = "https://github.com/google/blockly/wiki/Variables#set";
Blockly.Msg.STRING_SET_HELPURL = "https://github.com/google/blockly/wiki/Variables#set";
Blockly.Msg.STRING_SET_TOOLTIP = "Configura esta cadena de caracteres para ser igual a la entrada.";
 Blockly.Msg.RENAME_VARIABLE = "Renombrar variable...";
 Blockly.Msg.String_As="como Cadena de caracteres";
 Blockly.Msg.STRING_charat="Caracter en %1 en %2";
 Blockly.Msg.STRING_charat2="Caracter en";
 Blockly.Msg.STRING_compareTo="Comparar con";
 Blockly.Msg.STRING_Contact="Concatenar ";
 Blockly.Msg.STRING_LengthOf="Longitud de ";
 Blockly.Msg.STRING_Ends_With="Termina con ";
 Blockly.Msg.STRING_Equal="Igual a ";




//Conversions
 Blockly.Msg.CONV_tochar="Convertir en caracter";
 Blockly.Msg.CONV_tobyte="Convertir en Byte ";
 Blockly.Msg.CONV_toint="Convertir en Entero (Int)";
 Blockly.Msg.CONV_tofloat="Convertir en Coma Flotante (Float) ";


    
//ADVANCED I/O
 Blockly.Msg.TonePin="Tono PIN#";
Blockly.Msg.Frequence="Frecuencia";
 Blockly.Msg.Duration="Duración";
 Blockly.Msg.NoTonePin="No Tono PIN#";
 Blockly.Msg.Setup="Configuración Inicial (Setup)";
 Blockly.Msg.Loop="Bucle principal (Main loop)";
Blockly.Msg.sup=">";
 Blockly.Msg.supeg="=>";
 Blockly.Msg.inf="<";
 Blockly.Msg.infeg="<=";
